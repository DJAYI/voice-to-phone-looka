---
title: "品牌定位与讯息策略"
description: "制定与长期商业目标一致的全面战略计划，让品牌方向更清晰。"
...
intro:
  ...
  title: "统一品牌声音，脱颖而出，累积辨识度"
  description: "在竞争激烈的市场中，明确的品牌定位就是最大的资产。我们协助你梳理品牌叙事与沟通策略，让差异化价值被看见，并与目标受众建立长期连结。"
  button:
    enable: true
    label: "预约免费咨询"
    url: "/contact"
...
details:
  ...
  list:
    ...
    - enable: true
      ...
      title: "竞争版图分析"
      description: "检视主要竞争者的定位策略，找出能够突出的差异化叙事。"
      button:
        enable: true
        label: "立即开始"
        url: "/contact"
    ...
    - enable: true
      ...
      title: "品牌定位宣言"
      description: "撰写精炼有力的定位陈述，浓缩品牌独特价值。"
      button:
        enable: true
        label: "立即开始"
        url: "/contact"
    ...
    - enable: true
      ...
      title: "讯息层级框架"
      description: "建立适用于网站与社群的讯息结构，维持沟通一致性。"
      button:
        enable: true
        label: "立即开始"
        url: "/contact"
    ...
    - enable: true
      ...
      title: "品牌语气指南"
      description: "定义用词、语气与叙事节奏，确保每一次沟通都能贴近受众。"
      button:
        enable: true
        label: "立即开始"
        url: "/contact"
...
impact:
  enable: true
  title: "清晰讯息带来的影响"
  description: "有共鸣的讯息能快速建立信任与情感连结，也让团队在对外沟通时更有方向。"
  list:
    - 品牌认知度显著提升
    - 行销投资报酬更可预测
    - 内部团队参与感增强
    ...
    lg:
      - background:
        ...
        title:
          ...
          value: "71"
          appendValue: "%"
        description: "研究显示一致的品牌沟通可让辨识度提升 71%。"
    md:
      - background:
