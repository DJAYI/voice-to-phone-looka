...
list:
  - title: "Ahorro de costos"
    description: |
      <span class="text-primary text-lg font-semibold mb-2 block">Reduce costes operativos</span>
  ...
  - title: "Movilidad Total"
    description: |
      <span class="text-primary text-lg font-semibold mb-2 block">Comunicación sin fronteras</span>
  ...
  - title: "Flexibilidad"
    description: |
      <span class="text-primary text-lg font-semibold mb-2 block">Escala al ritmo de tu negocio</span>
